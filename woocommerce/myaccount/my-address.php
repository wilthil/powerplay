...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="small-12 large-6 columns address">
		<header class="title">
		...
		<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit veuse-button tiny"><?php _e( 'Edit', 'woocommerce' ); ?></a>
